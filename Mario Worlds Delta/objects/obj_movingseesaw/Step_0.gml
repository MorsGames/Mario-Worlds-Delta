...
|| (x > __view_get( e__VW.XView, view_current )+__view_get( e__VW.WView, view_current )+40) {

    //If the rope start point is outside the view
    if (xstart < __view_get( e__VW.XView, view_current )-40)
    || (xstart > __view_get( e__VW.XView, view_current )+__view_get( e__VW.WView, view_current )+40) {
