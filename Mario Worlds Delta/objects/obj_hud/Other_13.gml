...
draw_rectangle(_xx, _yy + _hh-8, _xx + _ww, _yy + _hh, false);
...
//Score
draw_text(_xx+_ww-64, _yy+_hh-8+_yp, string_hash_to_newline(string_format(score, 7, false)));
