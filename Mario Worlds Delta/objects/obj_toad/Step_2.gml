/// @description Manage Toad's animation

//Check if Toad is on a slippery surface
    ...
    //Otherwise
        ...
        if (crouch) {
            ...
            && (squat_ready == 2) {
                ...
                //If Toad is not holding anything
                if (holding == 0)
                    image_index = 0;
                
                //Otherwise, if Toad is holding something
                else {
        ...
        //Otherwise, if Toad is not longer crouched down
            ...
            || (holding == 99) {
                ...
                //If Toad is not sliding down a slope
                if (sliding == false) {
                
                    //If Toad is not kicking anything
                    if (kicking == false) {
                    
                        //If Toad is not moving
                        if (state == statetype.idle) {
                            ...
                            //If Toad is firing up a projectile
                            if (firing > 0)
                            ...
                            //Otherwise, if Toad is not firing up a projectile
                            else {
                        ...
                        //Otherwise, if Toad is walking
                            ...
                            //Before setting the walk sprite, check if Toad is moving in the opposite direction
                        ...
                        //Otherwise, if Toad is jumping
                        else if (state == statetype.jump) {
                        
                            //If Toad is not swimming
                            if (swimming == false) {
                                ...
                                //Otherwise, if Toad is not doing a spinjump
                                    ...
                                    //If Toad is firing a projectile
                                    if (firing > 0) {
                                    ...
                                    //Otherwise, if Toad is not firing a projectile
                                    else {
                                        ...
                                        //Otherwise, if Toad is not running
                                        else if (run == false) {
            ...
            //Otherwise, if the player is holding something
                ...
                //Otherwise, if Toad is not turning around
                else {
