...
&& (musicdisable == 0) {
    ...
    //Read values
    levelmusic  = ini_read_string(ini_section, "song_name", 0);
    loop_s      = ini_read_real(ini_section, "loop_s", 0);
    loop_e      = ini_read_real(ini_section, "loop_e", 1);
    sample_rate = ini_read_real(ini_section, "sample_rate", 0);
