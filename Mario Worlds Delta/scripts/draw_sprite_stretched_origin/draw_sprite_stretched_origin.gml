/// @description  draw_sprite_stretched_origin(sprite,subimg,ox,oy,scalex,scaley)
/// @param sprite
/// @param subimg
/// @param ox
/// @param oy
/// @param scalex
/// @param scaley
function draw_sprite_stretched_origin(argument0, argument1, argument2, argument3, argument4, argument5) {
	//
